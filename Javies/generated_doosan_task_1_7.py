"""
이 코드는 qwen2.5-coder-7B 모델이 생성한 1.7 버전 코드입니다. 다른 Task 입력에 대한 올바른 출력을 테스트하기 위해 생성되었습니다.
System, User 프롬프트는 동일합니다. 1.2 버전 이하와 비교하여 다음의 작업반장의 Task만 다릅니다. 특히 Task 중 shake는 프롬프트에 입력하지 않았으며,
이럴 경우 모델이 어떻게 대응하는지 확인하기 위해 의도적으로 추가된 Task입니다. 결과적으로 정의되지 않은 task는 무시하는 프롬프트 규칙을 잘 지켰습니다.
